-- Fix the create_customer_final function to ensure payment schedules are created
-- Run this in Supabase SQL Editor

-- Update the create_customer_final function with better error handling
...
-- Test the function with a sample (replace with actual promoter ID)
-- SELECT create_customer_final('Test User', '9999999999', 'Karnataka', 'Bangalore', '560001', 'Test Address', 'TEST123', 'password123', 'YOUR_PROMOTER_ID_HERE', 'test@example.com');
