-- =====================================================
-- PERMANENT FIX FOR ALL PROMOTERS (CORRECTED)
-- =====================================================
...
-- 3. Update affiliate_commissions (correct column names)
...
-- 4. Update profiles to match auth UIDs
UPDATE profiles p SET id = au.id
FROM auth.users au
WHERE p.email = au.email AND p.id != au.id;
