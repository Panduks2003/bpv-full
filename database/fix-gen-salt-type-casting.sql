-- =====================================================
-- FIX gen_salt TYPE CASTING ISSUE
-- =====================================================
-- Update the customer creation function to explicitly cast gen_salt parameter
...
BEGIN
    ...
    BEGIN
        ...
        -- Create auth user with explicit type casting for gen_salt
        INSERT INTO auth.users (
            ...
            gen_random_uuid(),
            auth_email,
            crypt(p_password, gen_salt('bf'::text)),  -- Explicit cast to text
            NOW(),
            NOW(),
            NOW(),
...
-- Verification
SELECT '✅ Customer creation function updated with explicit type casting for gen_salt' as status;
